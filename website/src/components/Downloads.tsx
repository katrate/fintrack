...
const DOWNLOADS = {
  ...
  macos: {
    ...
    files: [
      { name: "Apple Silicon (.dmg)", url: `https://github.com/katrate/fintrack/releases/download/v${version}/FinTrack-${version}-arm64.dmg` },
      { name: "Apple Silicon (.zip)", url: `https://github.com/katrate/fintrack/releases/download/v${version}/FinTrack-${version}-arm64-mac.zip` },
    ],
  },
}
